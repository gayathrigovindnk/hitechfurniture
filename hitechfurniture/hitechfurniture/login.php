...
<body>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="controller/login.php" method="post" >
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background: #ff3368;">
      ...
      <form action="controller/enteremail.php" method="post">
        <label for=""><b> Enter Your Registred Email Address</b></label><br>
        <input type="email" placeholder="Enter Email" name="email" class="form-control">
        <input type="submit" class="btn btn-danger" name="enteremail" style="margin-top: 20px;margin-left:180px">
      </form>
      </div>
