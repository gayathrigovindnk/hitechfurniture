...
<div class="d-flex justify-content-center align-items-center container">
        <div class="card py-5 px-3" style="background: #8696FE;">
          
        <form class="" action="controller/otpprocess.php" method="POST">
            <h5 class="m-0">Email verification</h5><span class="mobile-text" style="color:white">Enter the code we just send on your Email </span>
